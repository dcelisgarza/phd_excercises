...
\begin{document}
	...
	\begin{figure*}
		...
		\begin{subfigure}[c]{\linewidth}
			\centering
			\includegraphics[width=0.33\linewidth]{0_-1l.eps}
			~
			\includegraphics[width=0.33\linewidth]{1_-1l.eps}
			
			\includegraphics[width=0.33\linewidth]{2_-1l.eps}
			~
			\includegraphics[width=0.33\linewidth]{3_-1l.eps}
			
			\includegraphics[width=0.33\linewidth]{4_-1l.eps}
			~
			\includegraphics[width=0.33\linewidth]{6_-1l.eps}
		...
		\begin{subfigure}[c]{\linewidth}
			\centering
			\includegraphics[width=0.33\linewidth]{0_1l.eps}
			~
			\includegraphics[width=0.33\linewidth]{1_1l.eps}
			
			\includegraphics[width=0.33\linewidth]{2_1l.eps}
			~
			\includegraphics[width=0.33\linewidth]{3_1l.eps}
			
			\includegraphics[width=0.33\linewidth]{4_1l.eps}
			~
			\includegraphics[width=0.31\linewidth]{6_1l.eps}
